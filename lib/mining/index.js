...
class Miner {
    constructor() {
        ...
        _self.blockHeader = {
            ...
            hashMerkleRoot: "",
            target: blocks.getNextTargetByBlock(blocks.storage.getLastBlock()),
            noonce: 0
        };
    ...
    _mine() {
        ...
        if(blocks.difficulty.checkHashByTarget(hash, _self.blockHeader.target)) {
    ...
    _blockFound(block) {
        ...
        debug.log("block found", JSON.stringify(block, null, 2));
    ...
    _getFullBlock(hash) {
        ...
        return {
            ...
            header: {
                ...
                target: _self.blockHeader.target,
    ...
    updateLastBlock(block) {
        ...
        _self.blockHeader.target = blocks.getNextTargetByBlock(block);
