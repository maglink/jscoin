...
class Config {
    ...
    load(mainPath, filepath) {
        ...
        if(!this.data.storage.blocks) {
            this.data.storage.blocks = path.join(mainPath, "data/blocks.json")
        }
        if(!this.data.storage.utxos) {
            this.data.storage.utxos = path.join(mainPath, "data/utxos.json")
        }
