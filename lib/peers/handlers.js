...
module.exports.helloHandler = function(socket, info) {
    ...
    if(info.id === methods.helloId) {
        socket.destroy(new Error("It's me"));
        return;
    }
    socket.greeted = true;
...
module.exports.compareResultHandler = function(socket, body) {
    ...
    try {
        ...
        console.log("Compare result handler error: ", e.message);
...
module.exports.loadBlocksHandler = function(socket, body) {
    ...
    try {
        ...
        console.log("Load block request error: ", e.message);
...
module.exports.peersListHandler = function(socket, peersList) {
    ...
    console.log(socket.peerId, "handler", "peersListHandler");
    ...
    try {
        ...
        console.log("Invalid peers list: ", e.message);
        syncFlow = {};
