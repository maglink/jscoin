...
const TRX_MIN_AMOUNT = 1000000;//absolute min is 1000;
...
class Transaction {
    ...
    static fromData(data) {
        if(typeof data !== 'object') {
            throw new Error("Trx is not object");
        }
        if(typeof data.body !== 'object') {
            throw new Error("Trx body is not object");
        }
...
module.exports.createAndSendTransaction = function(to, amount, message, keyword) {
    ...
    peers.newTransaction(trx.getData());
};
...
module.exports.getTrxsListByAddress = function(address) {
    return storage._getTrxsWatchingByAddress(address);
};